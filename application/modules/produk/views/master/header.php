...
<head>
	...
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/core/libraries/jquery_ui/interactions.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/plugins/forms/styling/switch.min.js"></script>

	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/core/app.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/pages/form_select2.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/pages/form_layouts.js"></script>
	<!-- /theme JS files -->
