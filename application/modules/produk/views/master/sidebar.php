					...
					<div class="category-content no-padding">
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li>
								...
								<ul>
									<li <?php if($view == 'tambah'){echo 'class="active"';}?>><a href="<?php echo base_url()?>produk/tambah"><i class="icon-plus2"></i> Tambah</a></li>
									<li <?php if($view == 'index'){echo 'class="active"';}?>><a href="<?php echo base_url()?>produk"><i class="icon-stack2"></i> Semua Produk</a></li>
								</ul>
							</li>
							<li>
