					...
					<div class="category-content no-padding">
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li>
								...
								<ul>
									<li <?php if($view == 'index'){echo 'class="active"';}?>><a href="<?php echo base_url()?>order"><i class="icon-stack-empty"></i> Semua Order</a></li>
									<li <?php if($view == 'diproses'){echo 'class="active"';}?>><a href="<?php echo base_url()?>order/diproses"><i class="icon-stack-text"></i> Order Diproses</a></li>
									<li <?php if($view == 'selesai'){echo 'class="active"';}?>><a href="<?php echo base_url()?>order/selesai"><i class="icon-stack-check"></i> Order Selesai</a></li>
									<li <?php if($view == 'batal'){echo 'class="active"';}?>><a href="<?php echo base_url()?>order/batal"><i class="icon-stack-cancel"></i> Order Batal</a></li>
								</ul>
							</li>
							<li>
								<a href="#"><i class="icon-user"></i> <span>Users</span></a>
								<ul>
									<li><a href="<?php echo base_url()?>users/tambah"><i class="icon-plus2"></i> Tambah</a></li>
									<li><a href="<?php echo base_url()?>users"><i class="icon-users4"></i> Semua User</a></li>
									<li>
										...
										<ul>
											<?php
												...
												foreach($data as $d){
											?>
											<li><a href="<?php echo base_url()?>users/level/<?php echo $d->id_level; ?>"><i class="icon-user-check"></i> <?php echo $d->nama;?></a></li>
											<?php	
												}
											?>
										</ul>
