...
<head>
	...
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_PATH; ?>js/plugins/visualization/c3/c3.min.js"></script>
