	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><span class="text-semibold">Kategori Produk</span></h4>
			</div>
			
			<div class="heading-elements">
				<div class="heading-btn-group">
					<a href="<?php echo base_url()?>kategori/tambah" class="btn btn-link btn-float has-text"><i class="icon-plus3 text-primary"></i> <span>Tambah</span></a>
				</div>
			</div>
		</div>
							...
							<ul class="icons-list">
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><a href="<?php echo base_url()?>kategori/ubah/<?php echo $k->id_kategoriproduk?>"><i class="icon-pencil"></i> Edit</a></li>
									</ul>
								</li>
							</ul>
						</td>
