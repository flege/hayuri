					...
					<div class="category-content no-padding">
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li>
								...
								<ul>
									<li <?php if($view == 'tambah'){echo 'class="active"';}?>><a href="<?php echo base_url()?>kategori/tambah"><i class="icon-plus2"></i> Tambah</a></li>
									<li <?php if($view == 'index'){echo 'class="active"';}?>><a href="<?php echo base_url()?>kategori"><i class=" icon-price-tags2"></i> Semua Kategori Produk</a></li>
								</ul>
							</li>
							<li>
