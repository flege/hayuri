					...
					<div class="category-content no-padding">
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li>
								...
								<ul>
									<li <?php if($view == 'tambah'){echo 'class="active"';}?>><a href="<?php echo base_url()?>admin/tambah"><i class="icon-plus2"></i> Tambah</a></li>
									<li <?php if($view == 'index'){echo 'class="active"';}?>><a href="<?php echo base_url()?>admin"><i class="icon-users4"></i> Semua Admin</a></li>
								</ul>
							</li>
						</ul>
					</div>
