					...
					<div class="category-content no-padding">
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li>
								...
								<ul>
									<li <?php if($view == 'tambah'){echo 'class="active"';}?>><a href="<?php echo base_url()?>jenis/tambah"><i class="icon-plus2"></i> Tambah</a></li>
									<li <?php if($view == 'index'){echo 'class="active"';}?>><a href="<?php echo base_url()?>jenis"><i class=" icon-price-tags"></i> Semua Jenis Produk</a></li>
								</ul>
							</li>
							<li>
